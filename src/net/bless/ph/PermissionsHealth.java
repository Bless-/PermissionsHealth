...
public class PermissionsHealth extends JavaPlugin implements Listener {
	...
	public void onDisable() {
	    ...
	    getServer().getConsoleSender().sendMessage(ChatColor.RED + "|       " + ChatColor.WHITE + "HealthPermissions " + getDescription().getVersion() + " - Disable" + ChatColor.RED + "      |");
	    getServer().getConsoleSender().sendMessage(ChatColor.RED + "+----------------------------------------+");
	...
	public void onEnable() {
		getServer().getConsoleSender().sendMessage(ChatColor.RED + "+----------------------------------------+");
	    getServer().getConsoleSender().sendMessage(ChatColor.RED + "|       " + ChatColor.WHITE + "HealthPermissions " + getDescription().getVersion() + " - Enabled" + ChatColor.RED + "      |");
	    getServer().getConsoleSender().sendMessage(ChatColor.RED + "+----------------------------------------+");
